...
for lr in lrs:
    for alpha in alphas:
        ...
        estimator = GausEstimator(param_num, multiplier, X, Y, indices, lambda p,x,y:builder_gaus(p,x,y), lr=lr, prior_scale=np.array([alpha]*param_num), multistart=start_num, batch_size=10)            
